...
HD_PWD='F:/2_FPGA_Projects/2_Advanced_Projects/1_2FSK_UART/FSK_Modulation_Project/FSK_Modulation_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fsk_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fsk_top.tcl
