...
HD_PWD='F:/2_FPGA_Projects/2_Advanced_Projects/1_2FSK_UART/FSK_Modulation_Project/FSK_Modulation_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsk_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsk_top.tcl -notrace
